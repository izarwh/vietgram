    ...
    <main id="profile">
        <header class="profile__header">
            <div class="profile__column">
                <img src="<?=$_SESSION['pp']?>" style="width:50%; height:80%"/>
                <!-- photo di resize karena profile__column tidak membatasi height dan width foto -->
            </div>
            <div class="profile__column">
                <div class="profile__title">
                    <h3 class="profile__username"><?=$_SESSION['username']?></h3>
                    <a href="edit-profile.php">Edit profile</a>
                    <i class="fa fa-cog fa-lg"></i>
                </div>
                <ul class="profile__stats">
                    <li class="profile__stat">
                        <span class="stat__number"><?=$count?></span> posts
                    </li>
                    <li class="profile__stat">
                ...
                <p class="profile__bio">
                    ...
                    <a href="<?=$_SESSION['web']?>"><?php echo $_SESSION['website']?></a>
                </p>
            </div>
        </header>
